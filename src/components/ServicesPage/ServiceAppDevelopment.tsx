...
import img from "../../../public/images/App.webp";
...
export default function ServiceAppDevelopment() {
  ...
  return (
    <section className="bg-gradient-to-br from-pink-700 via-rose-800 to-gray-900 text-white py-24 px-6">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
        ...
        >
          <h2 className="text-4xl font-extrabold mb-6 tracking-tight leading-snug">
            <span className="text-pink-300">7.</span> E-com App Development
          </h2>

          <p className="text-gray-200 mb-8 text-lg leading-relaxed">
            Launch high-performing e-commerce apps with essential features like
            secure payments, order tracking, push notifications, and a smooth
            checkout experience—optimized for growth and scalability.
          </p>
